...
def create_trained_policy(
    ...
    *,
    ...
    if norm_stats is None:
        ...
        if (checkpoint_assets_dir / data_config.asset_id / "norm_stats.json").exists():
            norm_stats_dir = checkpoint_assets_dir
        else:
            norm_stats_dir = checkpoint_dir
        norm_stats = _checkpoints.load_norm_stats(norm_stats_dir, data_config.asset_id)
...
def setup_policy(args):
    ...
    if getattr(config.model, "pytorch_compile_mode", None) is not None:
